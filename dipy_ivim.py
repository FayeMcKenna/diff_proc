...
# load directory names
input_directory = "/Users/fayemckenna/Desktop/ivimtest"
#working_directory = "data/working"
output_directory = "/Users/fayemckenna/Desktop/ivimtest"
...
'''
plt.scatter(gtab.bvals, data[i, j, :],
...
save_nifti(output_directory + '/Ivimperf.nii.gz', ivimfit.perfusion_fraction, affine)
save_nifti(output_directory + '/Ivimdstar.nii.gz', ivimfit.D_star, affine)
save_nifti(output_directory + '/IvimD.nii.gz', ivimfit.D, affine)
"""
